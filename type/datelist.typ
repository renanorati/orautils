...
-- Member functions and procedures
  ...
  member function existe(data    varchar2
                        ,formato varchar2 default 'DD/MM/RRRR') return boolean,
  member procedure adicionar(self    in out nocopy datelist
                            ,data    datetime
                            ,repetir varchar2 default 'N'),
  member function adicionar(data    datetime
                           ,repetir varchar2 default 'N') return datelist,
  member procedure adicionar(data    date
                            ,repetir varchar2 default 'N'),
  member function adicionar(data    date
                           ,repetir varchar2 default 'N') return datelist,
  member procedure adicionar(list      varchar2
                            ,formato   varchar2 default 'DD/MM/RRRR'
                            ,separador varchar2 default ';'
                            ,repetir   varchar2 default 'N'),
  member function adicionar(list      varchar2
                           ,formato   varchar2 default 'DD/MM/RRRR'
                           ,separador varchar2 default ';'
                           ,repetir   varchar2 default 'N') return datelist,
  member procedure adicionar(lista   datelist
                            ,repetir varchar2 default 'N'),
  member function adicionar(lista   datelist
                           ,repetir varchar2 default 'N') return datelist,
  member procedure adicionar_periodo(inicio  datetime default datetime()
                                    ,fim     datetime default datetime()
                                    ,repetir varchar2 default 'N'),
  member function adicionar_periodo(inicio  datetime default datetime()
                                   ,fim     datetime default datetime()
                                   ,repetir varchar2 default 'N') return datelist,
  member procedure adicionar_periodo(inicio  date default null
                                    ,fim     date default null
                                    ,repetir varchar2 default 'N'),
  member function adicionar_periodo(inicio  date default null
                                   ,fim     date default null
                                   ,repetir varchar2 default 'N') return datelist,
  ...
  member procedure remover(self  in out nocopy datelist
                          ,lista datelist),
  member function remover(list      varchar2
                         ,formato   varchar2 default 'DD/MM/RRRR'
                         ,separador varchar2 default ';') return datelist,
  member procedure remover(list      varchar2
                          ,formato   varchar2 default 'DD/MM/RRRR'
                          ,separador varchar2 default ';'),
  member function remover_periodo(inicio datetime default datetime()
                                 ,fim    datetime default datetime()) return datelist,
  member procedure remover_periodo(self   in out nocopy datelist
                                  ,inicio datetime default datetime()
                                  ,fim    datetime default datetime()),
  member function remover_periodo(inicio date default null
                                 ,fim    date default null) return datelist,
  member procedure remover_periodo(inicio date default null
                                  ,fim    date default null),
  member function remover_periodo(inicio  varchar2 default null
                                 ,fim     varchar2 default null
                                 ,formato varchar2 default 'DD/MM/RRRR') return datelist,
  member procedure remover_periodo(inicio  varchar2 default null
                                  ,fim     varchar2 default null
                                  ,formato varchar2 default 'DD/MM/RRRR'),
  ...
  member procedure ordenar(self  in out nocopy datelist
                          ,ordem varchar2 default 'A'),
  ...
  member function dias_semana(formato   varchar2 default 'D'
                             ,separador varchar2 default ',') return varchar2,
  ...
  member function mostra(formato   varchar2 default 'DD/MM/RRRR'
                        ,separador varchar2 default ';') return varchar2
)
/
create or replace type body datelist is
  ...
  member function existe(data    varchar2
                        ,formato varchar2 default 'DD/MM/RRRR') return boolean is
  begin
  ...
  member function remover_periodo(inicio datetime default datetime()
                                 ,fim    datetime default datetime()) return datelist is
    result datelist := datelist();
  begin
    if self.list.first is not null then
      for reg in self.list.first .. self.list.last
  ...
  member procedure remover_periodo(self   in out nocopy datelist
                                  ,inicio datetime default datetime()
                                  ,fim    datetime default datetime()) is
  begin
